...
public interface HitRepository extends JpaRepository<EndpointHit, Long> {
    ...
    @Query("select new ru.practicum.ewm.statsservice.model.EndpointHit(h.app, h.uri, count(h)) " +
    ...
    @Query("select new ru.practicum.ewm.statsservice.model.EndpointHit(h.app, h.uri, count(distinct h.ip)) " +
            "from EndpointHit h where h.timestamp between :start and :end " +
